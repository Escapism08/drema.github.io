(function($) {
    ...
    var myColor;
    var all_questions = [{
        question_string: "لمن تقدم دريمة خدماتها؟",
        choices: {
            correct: "المسنين.",
            wrong: ["الأيتام مجهولي النسب.", "ذووي الإحتياجات الخاصة.", "ذووي الإحتياجات الخاصة."]
        }
    }, {
        question_string: "في اي منطقه يقع مركز دريمه؟",
        choices: {
            correct: "المعموره",
            wrong: ["الهلال", "عين خالد"]
        }
    }, {
        question_string: "كم عدد المراكز التابعه لمؤسسة العمل الاجتماعي؟",
        choices: {
            correct: "7",
            wrong: ["6", "9", "8"]
        }
    }, {
        question_string: 'ما معنى كلمة دريمه؟',
        choices: {
            correct: "Cascading Style Sheets",
            wrong: ["Computer Style Sheets", "Colorful Style Sheets", "Creative Style Sheets"]
        }
    }, {
        question_string: 'متى تم افتتاح دريمه؟',
        choices: {
            correct: "W3C",
            wrong: ["Mozilla", "Microsoft", "Google"]
        }
    },{
        question_string: 'من هو سفير الأيتام لسنة ٢٠١٧؟',
        choices: {
            correct: "W3C",
            wrong: ["Mozilla", "Microsoft", "Google"]
        }
    },{
        question_string: 'الى اي مؤسسه يتبع مركز دريمه؟',
        choices: {
            correct: "W3C",
            wrong: ["Mozilla", "Microsoft", "Google"]
        }
    },{
        question_string: 'في أي شهر تحتفل دريمة بيوم اليتيم العربي؟',
        choices: {
            correct: "W3C",
            wrong: ["Mozilla", "Microsoft", "Google"]
        }
    },{
        question_string: 'أحتفل مركز رعاية الايتام دريمة مؤخرا بيوم دريمة ٢٠١٧ تحت شعار؟',
        choices: {
            correct: "W3C",
            wrong: ["Mozilla", "Microsoft", "Google"]
        }
    ...
    Quiz.prototype.render = function(container) {
        ...
        $('#submitButton').click(function() {
            ...
            if (percentage === 1) {
                icon = "fa fa-smile-o";
                message = '<div class="congrats"><h1>Congratulations!</h1></div>';
                chartcolor = "green";
            } else if (percentage >= .75) {
                icon = "fa fa-smile-o";
                message = 'Congratulations! <br> Claim your reward at the booth';
                chartcolor = "green";
